...
namespace Ymatou.StaticContent.DataModel.Template.App.AppSpecialSaleOnScene
{
    ...
    public class MiddleBannerBlock : IBlock
    {
        ...
        {
            get { return AppSpecialSaleOnSceneBlockEnum.MiddleBannerBlock; }
        }
    ...
    public class MiddleBannerBlockItemViewModel : IBlockItemViewModel
    {
        ...
        /// 
        /// </summary>
        [DisplayName(CNName = "Banner链接", InputFormat = DisplayNameInputFormat.Link, MaxLength=1024, Tips = "请输入完整的链接，eg:http://www.ymatou.com/")]
